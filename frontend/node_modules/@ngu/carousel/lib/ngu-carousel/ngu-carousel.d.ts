export declare class NguCarouselStore {
    ...
    isEnd: boolean;
    readonly isFirst: import("@angular/core").WritableSignal<boolean>;
    readonly isLast: import("@angular/core").WritableSignal<boolean>;
    RTL: boolean;
    point: boolean;
    velocity: number;
    constructor(touch?: Touch, vertical?: Vertical, interval?: CarouselInterval | undefined, transform?: Transfrom, button?: NguButton | undefined, visibleItems?: ItemsControl | undefined, deviceType?: DeviceType | undefined, type?: string, token?: string, items?: number, load?: number, deviceWidth?: number, carouselWidth?: number, itemWidth?: number, slideItems?: number, itemWidthPer?: number, itemLength?: number, currentSlide?: number, easing?: string, speed?: number, loop?: boolean, dexVal?: number, touchTransform?: number, isEnd?: boolean, isFirst?: import("@angular/core").WritableSignal<boolean>, isLast?: import("@angular/core").WritableSignal<boolean>, RTL?: boolean, point?: boolean, velocity?: number);
}
