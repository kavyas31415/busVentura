(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('html2canvas'), require('rxjs'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-feedback', ['exports', 'html2canvas', 'rxjs', '@angular/common', '@angular/core'], factory) :
    (factory((global['ngx-feedback'] = {}),global.html2canvas,global.rxjs,global.ng.common,global.ng.core));
}(this, (function (exports,html2canvas,rxjs,common,i0) { 'use strict';
    ...
    var FeedbackButtonComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FeedbackButtonComponent.ctorParameters = function () {
            return [
                { type: EventsService }
            ];
        };
    ...
    var ModalService = /** @class */ (function () {
        ...
        /** @nocollapse */ ModalService.ngInjectableDef = i0.defineInjectable({ factory: function ModalService_Factory() { return new ModalService(i0.inject(ComponentLoaderService)); }, token: ModalService, providedIn: "root" });
        return ModalService;
    }());
    ...
    var SelectorsService = /** @class */ (function () {
         ...
         */
            function () {
                ...
                /** @type {?} */
                var elements = [];
                this.source = rxjs.fromEvent(document, 'mousemove').subscribe(( /**
                 * @param {?} ev
                 * @return {?}
                 */function (ev) {
                    if (element) {
                     ...
                     */function (el) { return el === element; })) === -1) {
                        ...
                        _this.subs.push(rxjs.fromEvent(element, 'click').subscribe(( /**
                         * @param {?} evt
                         * @return {?}
                         */function (evt) {
                            evt.stopPropagation();
        ...
        /** @nocollapse */
        SelectorsService.ctorParameters = function () {
            return [
    ...
    var OrchestratorService = /** @class */ (function () {
        ...
        /** @nocollapse */
        OrchestratorService.ctorParameters = function () {
            return [
                { type: ModalService },
        ...
        /** @nocollapse */ OrchestratorService.ngInjectableDef = i0.defineInjectable({ factory: function OrchestratorService_Factory() { return new OrchestratorService(i0.inject(ModalService), i0.inject(SelectorsService), i0.inject(EventsService)); }, token: OrchestratorService, providedIn: "root" });
    ...
    var NgxFeedbackService = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxFeedbackService.ctorParameters = function () {
            return [
                { type: ComponentLoaderService },
                { type: OrchestratorService }
            ];
        };
        /** @nocollapse */ NgxFeedbackService.ngInjectableDef = i0.defineInjectable({ factory: function NgxFeedbackService_Factory() { return new NgxFeedbackService(i0.inject(ComponentLoaderService), i0.inject(OrchestratorService)); }, token: NgxFeedbackService, providedIn: "root" });
...
//# sourceMappingURL=ngx-feedback.umd.js.map